...
CREATE TABLE `turmas` (
  ...
  KEY `fk_turma_disciplinas` (`id_disciplina`),
  CONSTRAINT `fk_turma_disciplinas` FOREIGN KEY (`id_disciplina`) REFERENCES `disciplinas` (`id`),
...
-- Dump completed on 2017-10-13 10:24:07
